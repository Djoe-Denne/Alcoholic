# craft_mash_tun_controller textures
...
Hull cubes are a copper recolor of `industrial_mash_tun_controller`. Desk / pictogram /
fitting cubes stay on the industrial paint (steel pupitre, lamps off).

Do not write this atlas back onto `industrial_mash_tun_controller`.

## Brief

- **Id** : `craft_mash_tun_controller` — contrôleur unitaire 1×1 (non formé).
- **Refs** : `art/blockbench/craft_mash_tun_controller/reference.png`.
