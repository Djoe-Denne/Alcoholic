...
Hull cubes are a copper recolor of `industrial_vat_controller`. Desk / pictogram /
fitting cubes stay on the industrial paint (steel pupitre, lamps off).

Do not write this atlas back onto `industrial_vat_controller`.

## Brief

- **Id** : `craft_vat_controller` — contrôleur unitaire 1×1 (non formé).
- **Refs** : `art/blockbench/craft_vat_controller/reference.png`.
