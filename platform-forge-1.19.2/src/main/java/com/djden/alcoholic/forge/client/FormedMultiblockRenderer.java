...
/**
 * Press-only overlay: iron platen animation and optional crush debug lines.
 * Formed hulls stay as the 1×1 blocks the player placed.
 */
public class FormedMultiblockRenderer implements BlockEntityRenderer<MultiblockControllerBlockEntity> {
    ...
    public void render(
        ...
        if (BuiltinMachines.INDUSTRIAL_PRESS.equals(entity.definitionId())) {
