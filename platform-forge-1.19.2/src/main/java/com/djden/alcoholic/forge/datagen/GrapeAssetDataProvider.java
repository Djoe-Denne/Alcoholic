                ...
                """
                        {
                          ...
                          "block.alcoholic.bottle_rack": "Bottle Rack",
                          "block.alcoholic.bottle_shelf": "Bottle Shelf",
                          "container.alcoholic.bottle_rack": "Bottle Rack",
                          "container.alcoholic.bottle_shelf": "Bottle Shelf",
                          ...
                          "message.alcoholic.port.mode.input": "input",
                          "message.alcoholic.port.mode.output": "output",
                          "message.alcoholic.port.mode.both": "both",
                          ...
                          "gui.alcoholic.telemetry": "Controller data",
                          "gui.alcoholic.structure.formed": "Structure: formed",
                          "gui.alcoholic.structure.unformed": "Structure: unformed",
                          "gui.alcoholic.structure.reason.controller_chunk": "Controller chunk is unloaded",
                          "gui.alcoholic.structure.reason.wrong_origin": "This block is not this machine's controller",
                          "gui.alcoholic.structure.reason.unloaded_chunk": "The hull spans an unloaded chunk",
                          "gui.alcoholic.structure.reason.over_budget": "Connected hull exceeds the size budget",
                          "gui.alcoholic.structure.reason.dimensions": "Size %sx%sx%s is outside the allowed range",
                          "gui.alcoholic.structure.reason.shell_unloaded": "A hull cell is unloaded",
                          "gui.alcoholic.structure.reason.open_shell": "Hull is not a closed connected frame",
                          "gui.alcoholic.structure.reason.unsupported_shell": "Unsupported block on the hull",
                          "gui.alcoholic.structure.reason.foreign_controller": "A foreign controller is on the hull",
                          "gui.alcoholic.structure.reason.interior_unloaded": "An interior cell is unloaded",
                          "gui.alcoholic.structure.reason.interior_blocked": "Interior is obstructed",
                          "gui.alcoholic.structure.reason.controller_count": "Controller count %s (need %s)",
                          "gui.alcoholic.structure.reason.missing_port": "Missing required port: %s",
                          "gui.alcoholic.structure.reason.overcapacity": "Stored %s mB exceeds new capacity %s",
                          "gui.alcoholic.structure.reason.resize_failed": "Contents exceed the resized capacity",
                          "gui.alcoholic.profile": "Profile: %s",
                          "gui.alcoholic.stage": "Stage: %s",
                          "gui.alcoholic.progress": "Progress: %s%%",
                          "gui.alcoholic.ambient": "Ambient: %s°C",
                          "gui.alcoholic.heat": "Heat below: %s°C",
                          "gui.alcoholic.preferred": "Ideal: %s–%s°C",
                          "gui.alcoholic.operating": "Operating: %s–%s°C",
                          "gui.alcoholic.humidity": "Humidity: %s%% (min %s%%)",
                          "gui.alcoholic.kiln_minimum": "Kiln minimum: %s°C",
                          "gui.alcoholic.drive_telemetry": "Drive: %s (%s–%s)",
                          "gui.alcoholic.drive_capacity": "Capacity: %s (min %s)",
                          "gui.alcoholic.stage.idle": "idle",
                          "gui.alcoholic.stage.pressing": "pressing",
                          "gui.alcoholic.stage.fermenting": "fermenting",
                          "gui.alcoholic.stage.steeping": "steeping",
                          "gui.alcoholic.stage.germination": "germination",
                          "gui.alcoholic.stage.kilning": "kilning",
                          "gui.alcoholic.stage.milling": "milling",
                          "gui.alcoholic.stage.mash": "mashing",
                          "gui.alcoholic.stage.boil": "boiling",
                          "gui.alcoholic.stage.condition": "conditioning",
                          "gui.alcoholic.stage.conditioned": "conditioned",
                          "gui.alcoholic.stage.age": "aging",
                          "gui.alcoholic.stage.aged": "aged",
                          "gui.alcoholic.stage.stalled": "too cold to ferment",
                          "gui.alcoholic.stage.awaiting_yeast": "awaiting yeast",
                          "gui.alcoholic.stage.fermented": "fermented",
                          ...
                          "advancements.alcoholic.form_craft_malt_house.title": "Formed Craft Malt House",
                          "advancements.alcoholic.form_craft_malt_house.description": "Assemble a craft-scale malt house",
                          "advancements.alcoholic.form_craft_mill.title": "Formed Craft Mill",
                          "advancements.alcoholic.form_craft_mill.description": "Assemble a craft-scale mill",
                          "advancements.alcoholic.form_craft_mash_tun.title": "Formed Craft Mash Tun",
                          "advancements.alcoholic.form_craft_mash_tun.description": "Assemble a craft-scale mash tun",
                          "advancements.alcoholic.form_craft_kettle.title": "Formed Craft Kettle",
                          "advancements.alcoholic.form_craft_kettle.description": "Assemble a craft-scale brewing kettle",
                          "advancements.alcoholic.form_craft_vat.title": "Formed Craft Vat",
                          "advancements.alcoholic.form_craft_vat.description": "Assemble a craft-scale fermentation vat",
                          "advancements.alcoholic.condition_beer.title": "Conditioned Beer",
                          "advancements.alcoholic.condition_beer.description": "Finish a beer in an industrial conditioning vessel",
                          "jei.alcoholic.category.multiblock_formation": "Formation",
                          "jei.alcoholic.formation.size": "%1$s×%2$s×%3$s",
                          "jei.alcoholic.formation.size_max": "%1$s×%2$s×%3$s · max %4$s×%5$s×%6$s",
                          ...
                          "ftbquests.alcoholic.hover.fermenter": "Pour must or hopped wort, then add yeast. Room temperature (18–24 °C) is enough; magma below gently warms a cold cellar. Bottle or bucket when it is done.",
                ...
                """
                        {
                          ...
                          "block.alcoholic.bottle_rack": "Casier à bouteilles",
                          "block.alcoholic.bottle_shelf": "Étagère à bouteilles",
                          "container.alcoholic.bottle_rack": "Casier à bouteilles",
                          "container.alcoholic.bottle_shelf": "Étagère à bouteilles",
                          ...
                          "message.alcoholic.port.mode.input": "entrée",
                          "message.alcoholic.port.mode.output": "sortie",
                          "message.alcoholic.port.mode.both": "les deux",
                          ...
                          "gui.alcoholic.telemetry": "Données du contrôleur",
                          "gui.alcoholic.structure.formed": "Structure : formée",
                          "gui.alcoholic.structure.unformed": "Structure : non formée",
                          "gui.alcoholic.structure.reason.controller_chunk": "Le chunk du contrôleur n'est pas chargé",
                          "gui.alcoholic.structure.reason.wrong_origin": "Ce bloc n'est pas le contrôleur de cette machine",
                          "gui.alcoholic.structure.reason.unloaded_chunk": "La coque traverse un chunk non chargé",
                          "gui.alcoholic.structure.reason.over_budget": "La coque connectée dépasse le budget de taille",
                          "gui.alcoholic.structure.reason.dimensions": "Taille %sx%sx%s hors de la plage autorisée",
                          "gui.alcoholic.structure.reason.shell_unloaded": "Une cellule de coque n'est pas chargée",
                          "gui.alcoholic.structure.reason.open_shell": "La coque n'est pas un cadre fermé et connecté",
                          "gui.alcoholic.structure.reason.unsupported_shell": "Bloc non supporté sur la coque",
                          "gui.alcoholic.structure.reason.foreign_controller": "Un autre contrôleur est sur la coque",
                          "gui.alcoholic.structure.reason.interior_unloaded": "Une cellule intérieure n'est pas chargée",
                          "gui.alcoholic.structure.reason.interior_blocked": "L'intérieur est obstrué",
                          "gui.alcoholic.structure.reason.controller_count": "Nombre de contrôleurs %s (il en faut %s)",
                          "gui.alcoholic.structure.reason.missing_port": "Port requis manquant : %s",
                          "gui.alcoholic.structure.reason.overcapacity": "%s mB stockés dépassent la nouvelle capacité %s",
                          "gui.alcoholic.structure.reason.resize_failed": "Le contenu dépasse la capacité après redimensionnement",
                          "gui.alcoholic.profile": "Profil : %s",
                          "gui.alcoholic.stage": "Étape : %s",
                          "gui.alcoholic.progress": "Progression : %s%%",
                          "gui.alcoholic.ambient": "Ambiante : %s°C",
                          "gui.alcoholic.heat": "Chaleur dessous : %s°C",
                          "gui.alcoholic.preferred": "Idéal : %s–%s°C",
                          "gui.alcoholic.operating": "Opérable : %s–%s°C",
                          "gui.alcoholic.humidity": "Humidité : %s%% (min %s%%)",
                          "gui.alcoholic.kiln_minimum": "Touraillage min. : %s°C",
                          "gui.alcoholic.drive_telemetry": "Entraînement : %s (%s–%s)",
                          "gui.alcoholic.drive_capacity": "Capacité : %s (min %s)",
                          "gui.alcoholic.stage.idle": "inactive",
                          "gui.alcoholic.stage.pressing": "pressage",
                          "gui.alcoholic.stage.fermenting": "fermentation",
                          "gui.alcoholic.stage.steeping": "trempage",
                          "gui.alcoholic.stage.germination": "germination",
                          "gui.alcoholic.stage.kilning": "touraillage",
                          "gui.alcoholic.stage.milling": "mouture",
                          "gui.alcoholic.stage.mash": "empâtage",
                          "gui.alcoholic.stage.boil": "ébullition",
                          "gui.alcoholic.stage.condition": "conditionnement",
                          "gui.alcoholic.stage.conditioned": "conditionné",
                          "gui.alcoholic.stage.age": "élevage",
                          "gui.alcoholic.stage.aged": "élevé",
                          "gui.alcoholic.stage.stalled": "trop froid pour fermenter",
                          "gui.alcoholic.stage.awaiting_yeast": "en attente de levure",
                          "gui.alcoholic.stage.fermented": "fermenté",
                          ...
                          "advancements.alcoholic.form_craft_malt_house.title": "Malterie artisanale formée",
                          "advancements.alcoholic.form_craft_malt_house.description": "Assemblez une malterie à l'échelle craft",
                          "advancements.alcoholic.form_craft_mill.title": "Moulin artisanal formé",
                          "advancements.alcoholic.form_craft_mill.description": "Assemblez un broyeur à l'échelle craft",
                          "advancements.alcoholic.form_craft_mash_tun.title": "Cuve-matière artisanale formée",
                          "advancements.alcoholic.form_craft_mash_tun.description": "Assemblez une cuve-matière à l'échelle craft",
                          "advancements.alcoholic.form_craft_kettle.title": "Chaudière artisanale formée",
                          "advancements.alcoholic.form_craft_kettle.description": "Assemblez une chaudière à l'échelle craft",
                          "advancements.alcoholic.form_craft_vat.title": "Cuve artisanale formée",
                          "advancements.alcoholic.form_craft_vat.description": "Assemblez une cuve de fermentation à l'échelle craft",
                          "advancements.alcoholic.condition_beer.title": "Bière conditionnée",
                          "advancements.alcoholic.condition_beer.description": "Terminez une bière dans une cuve de conditionnement industrielle",
                          "jei.alcoholic.category.multiblock_formation": "Formation",
                          "jei.alcoholic.formation.size": "%1$s×%2$s×%3$s",
                          "jei.alcoholic.formation.size_max": "%1$s×%2$s×%3$s · max %4$s×%5$s×%6$s",
                          "jei.alcoholic.formation.layer": "Y = %s",
                          ...
                          "ftbquests.alcoholic.hover.fermenter": "Versez le moût ou le moût houblonné, puis la levure. L'ambiance (18–24 °C) suffit ; un magma dessous réchauffe doucement une cave froide. Bouteille ou seau à la fin.",
