...
summary: How Alcoholic authors one Java machine in Blockbench: one target, grey silhouette, 512 paint, user stop, then downsample.
provenance:
  extracted: 0.86
  inferred: 0.12
  ambiguous: 0.02
...
6. Screenshot several angles. Stop and wait for approval.
7. Only then downsample from the master and export into `assets/alcoholic/` plus `resourcepacks/`.
