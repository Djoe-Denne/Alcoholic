...
summary: Extra PRESS and FERMENT executors plus a passive tank. Kinetic power is any MechanicalDrivePort supply, not Create-only.
provenance:
  extracted: 0.86
  inferred: 0.12
  ambiguous: 0.02
