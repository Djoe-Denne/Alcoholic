...
Drink quality is not a persisted 0–100 field. See [[emergent-quality-profile]] and [[quality-operator-dag]]. `alcoholic:quality` remains harvest lot quality. Ethanol is displayed separately and never enters the profile. An executor may stamp `alcoholic:complexity_cap` / `alcoholic:purity_floor` so industrial ceilings survive bottling. See ADR-037.
