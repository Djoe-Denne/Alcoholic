...
public final class SemanticTags {
    ...
    public static final ResourceId BARLEY_SEEDS = tag("barley/seeds");
    ...
    public static final ResourceId MALTED_BARLEY = tag("malted_barley");
    public static final ResourceId MALTED_GRAIN = tag("malted_grain");
    public static final ResourceId GRIST = tag("grist");
    public static final ResourceId SPENT_GRAIN = tag("spent_grain");
